...
Runs a Strands agent and records model/tool activity to Grafana Cloud.
...
Configure agento11y and OTel endpoints from your Grafana Cloud stack. See the [Grafana Cloud AI Observability getting started docs](https://grafana.com/docs/grafana-cloud/machine-learning/ai-observability/get-started/grafana-cloud/) for where to find each value:
...
to the agento11y client. Generations go to `AGENTO11Y_ENDPOINT`; SDK metrics go to
...
When the agent response prints, followed by `Done`, open Agent Observability in your Grafana Cloud stack to inspect the recorded generation.
