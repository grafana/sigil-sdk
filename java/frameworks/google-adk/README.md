# Grafana Agent Observability Java Framework Helper: Google ADK

This module maps Google ADK callback/interceptor lifecycles to agento11y generation and tool recording lifecycles.
