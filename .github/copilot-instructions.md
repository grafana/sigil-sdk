# Sigil SDK — Copilot Instructions

You are working in the Grafana Sigil SDK monorepo. Keep patches easy to review and maintain. Add concise rationale comments only where logic is non-obvious.
