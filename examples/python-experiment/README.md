...
export RUN_ID=experiment-example-${GIT_SHA:-manual}
...
View in Sigil: https://<your-stack>.grafana.net/a/grafana-sigil-app/evaluation/experiments/experiment-example-manual
```
