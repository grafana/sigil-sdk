...
def test_agento11y_google_adk_sync_lifecycle_sets_framework_metadata() -> None:
...
def test_agento11y_google_adk_keeps_thread_metadata_when_ids_are_split_across_payloads() -> None:
    exporter = _CapturingExporter()
    client = _new_client(exporter)
...
def test_agento11y_google_adk_fallback_conversation_is_deterministic() -> None:
    exporter = _CapturingExporter()
    client = _new_client(exporter)
...
def test_agento11y_google_adk_stream_mode_uses_chunks_when_output_missing() -> None:
    exporter = _CapturingExporter()
    client = _new_client(exporter)
...
def test_agento11y_google_adk_generation_span_tracks_active_parent_span_and_export_lineage() -> None:
    exporter = _CapturingExporter()
...
def test_agento11y_google_adk_normalizes_extra_metadata() -> None:
    exporter = _CapturingExporter()
    client = _new_client(exporter)
...
def test_agento11y_google_adk_async_handler_records_generation() -> None:
    exporter = _CapturingExporter()
    client = _new_client(exporter)
...
def test_agento11y_google_adk_callback_helpers_attach_callback_fields() -> None:
    exporter = _CapturingExporter()
    client = _new_client(exporter)
...
def test_agento11y_google_adk_handler_explicitly_has_no_embedding_lifecycle() -> None:
    exporter = _CapturingExporter()
    client = _new_client(exporter)
    try:
        handler = Agento11yGoogleAdkHandler(client=client)
...
def test_agento11y_google_adk_callbacks_close_tool_runs_without_function_call_id() -> None:
...
def test_agento11y_google_adk_plugin_helpers_attach_plugin_list() -> None:
    exporter = _CapturingExporter()
    client = _new_client(exporter)
...
def test_agento11y_google_adk_plugin_maps_current_request_config_tools_and_usage() -> None:
    exporter = _CapturingExporter()
    client = _new_client(exporter)
...
def test_agento11y_google_adk_plugin_streams_partial_event_tokens() -> None:
    exporter = _CapturingExporter()
    client = _new_client(exporter)
...
def test_agento11y_google_adk_plugin_tracks_nested_agent_chain_runs() -> None:
    class _CapturingHandler:
        def __init__(self) -> None:
