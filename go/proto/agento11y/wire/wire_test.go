...
func TestJSONRoundTripUsesProtoNames(t *testing.T) {
	req := &agento11yv1.ExportGenerationsRequest{
		Generations: []*agento11yv1.Generation{{
			Id:             "gen-1",
...
func TestWorkflowStepJSONRoundTripUsesProtoNames(t *testing.T) {
	req := &agento11yv1.ExportWorkflowStepsRequest{
		WorkflowSteps: []*agento11yv1.WorkflowStep{{
			Id:             "wfs-1",
			ConversationId: "conv-1",
			StepName:       "route",
			AgentName:      "test-agent",
...
func TestJSONResponseRoundTrip(t *testing.T) {
	resp := &agento11yv1.ExportGenerationsResponse{
...
func TestWorkflowStepJSONResponseRoundTrip(t *testing.T) {
	resp := &agento11yv1.ExportWorkflowStepsResponse{
		Results: []*agento11yv1.ExportWorkflowStepResult{
...
func TestProtoRoundTrip(t *testing.T) {
	...
	resp := &agento11yv1.ExportGenerationsResponse{
		Results: []*agento11yv1.ExportGenerationResult{{GenerationId: "gen-bin", Accepted: true}},
	}
