...
class SigilEnvConfigTest {
    ...
    void preferredOnlyMatchesLegacyOnly() {
        SigilClientConfig preferred = resolve(allFieldsEnv("AGENTO11Y_")).config();
        SigilClientConfig legacy = resolve(allFieldsEnv("SIGIL_")).config();
    ...
    void callerEndpointBeatsBothPrefixes() {
        ...
        SigilClientConfig cfg = SigilEnvConfig.resolveFromEnv(env::get, base).config();
        assertThat(cfg.getGenerationExport().getEndpoint()).isEqualTo("https://caller-host");
    }
    ...
    @Test
    void legacyConstantsKeepSigilNames() {
        assertThat(SigilEnvConfig.ENV_ENDPOINT).isEqualTo("SIGIL_ENDPOINT");
        assertThat(SigilEnvConfig.ENV_PROTOCOL).isEqualTo("SIGIL_PROTOCOL");
        assertThat(SigilEnvConfig.ENV_INSECURE).isEqualTo("SIGIL_INSECURE");
        assertThat(SigilEnvConfig.ENV_HEADERS).isEqualTo("SIGIL_HEADERS");
        assertThat(SigilEnvConfig.ENV_AUTH_MODE).isEqualTo("SIGIL_AUTH_MODE");
        assertThat(SigilEnvConfig.ENV_AUTH_TENANT_ID).isEqualTo("SIGIL_AUTH_TENANT_ID");
        assertThat(SigilEnvConfig.ENV_AUTH_TOKEN).isEqualTo("SIGIL_AUTH_TOKEN");
        assertThat(SigilEnvConfig.ENV_AGENT_NAME).isEqualTo("SIGIL_AGENT_NAME");
        assertThat(SigilEnvConfig.ENV_AGENT_VERSION).isEqualTo("SIGIL_AGENT_VERSION");
        assertThat(SigilEnvConfig.ENV_USER_ID).isEqualTo("SIGIL_USER_ID");
        assertThat(SigilEnvConfig.ENV_TAGS).isEqualTo("SIGIL_TAGS");
        assertThat(SigilEnvConfig.ENV_CONTENT_CAPTURE_MODE).isEqualTo("SIGIL_CONTENT_CAPTURE_MODE");
        assertThat(SigilEnvConfig.ENV_DEBUG).isEqualTo("SIGIL_DEBUG");
    }

    @Test
    void preferredConstantsUseAgentO11yNames() {
        assertThat(SigilEnvConfig.ENV_ENDPOINT_PREFERRED).isEqualTo("AGENTO11Y_ENDPOINT");
        assertThat(SigilEnvConfig.ENV_PROTOCOL_PREFERRED).isEqualTo("AGENTO11Y_PROTOCOL");
        assertThat(SigilEnvConfig.ENV_INSECURE_PREFERRED).isEqualTo("AGENTO11Y_INSECURE");
        assertThat(SigilEnvConfig.ENV_HEADERS_PREFERRED).isEqualTo("AGENTO11Y_HEADERS");
        assertThat(SigilEnvConfig.ENV_AUTH_MODE_PREFERRED).isEqualTo("AGENTO11Y_AUTH_MODE");
        assertThat(SigilEnvConfig.ENV_AUTH_TENANT_ID_PREFERRED).isEqualTo("AGENTO11Y_AUTH_TENANT_ID");
        assertThat(SigilEnvConfig.ENV_AUTH_TOKEN_PREFERRED).isEqualTo("AGENTO11Y_AUTH_TOKEN");
        assertThat(SigilEnvConfig.ENV_AGENT_NAME_PREFERRED).isEqualTo("AGENTO11Y_AGENT_NAME");
        assertThat(SigilEnvConfig.ENV_AGENT_VERSION_PREFERRED).isEqualTo("AGENTO11Y_AGENT_VERSION");
        assertThat(SigilEnvConfig.ENV_USER_ID_PREFERRED).isEqualTo("AGENTO11Y_USER_ID");
        assertThat(SigilEnvConfig.ENV_TAGS_PREFERRED).isEqualTo("AGENTO11Y_TAGS");
        assertThat(SigilEnvConfig.ENV_CONTENT_CAPTURE_MODE_PREFERRED).isEqualTo("AGENTO11Y_CONTENT_CAPTURE_MODE");
        assertThat(SigilEnvConfig.ENV_DEBUG_PREFERRED).isEqualTo("AGENTO11Y_DEBUG");
    }
}
